// test/trie/stable_trie_benchmark.cpp
...
BOOST_AUTO_TEST_SUITE(stable_trie_benchmark__test)

BOOST_AUTO_TEST_CASE(stable_trie_benchmark__serialize_1)
{
	...
	std::cout << "---------- stable_trie_benchmark__serialize_1 ----------" << std::endl;
	std::cout << "stable_trie<char32_t>" << std::endl;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__serialize_2)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__serialize_2 ----------" << std::endl;
	std::cout << "stable_trie<char16_t>" << std::endl;
	std::cout << "\tsize():\t" << t1.size() << std::endl;
	std::cout << "\tnodes:\t" << (buf.size() / 2) << std::endl;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__serialize_3)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__serialize_3 ----------" << std::endl;
	std::cout << "stable_trie<char>" << std::endl;
	std::cout << "\tsize():\t" << t1.size() << std::endl;
	std::cout << "\tnodes:\t" << (buf.size() / 2) << std::endl;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__serialize_4)
{
	using namespace wordring;
	...
	std::cout.imbue(std::locale(""));
	std::cout << "---------- stable_trie_benchmark__serialize_4 ----------" << std::endl;
	std::cout << "stable_trie<char32_t>" << std::endl;
	std::cout << "\tsize():\t" << t1.size() << std::endl;
	std::cout << "\tnodes:\t" << (buf.size() / 2) << std::endl;
	...
	start = std::chrono::system_clock::now();
	stable_trie<char32_t> t2{ v.begin(), v.end() };
	duration = std::chrono::system_clock::now() - start;

	std::cout << "stable_trie<char32_t> t2{ v.begin(), v.end() }: " << std::chrono::duration_cast<std::chrono::milliseconds>(duration).count() << "ms" << std::endl;
	std::cout << "\tsize():\t" << t2.size() << std::endl;

	std::cout << std::endl;
}

BOOST_AUTO_TEST_CASE(stable_trie_benchmark__serialize_5)
{
	using namespace wordring;
	...
	std::cout.imbue(std::locale(""));
	std::cout << "---------- stable_trie_benchmark__serialize_5 ----------" << std::endl;
	std::cout << "stable_trie<char16_t>" << std::endl;
	std::cout << "\tsize():\t" << t1.size() << std::endl;
	std::cout << "\tnodes:\t" << (buf.size() / 2) << std::endl;
	...
	start = std::chrono::system_clock::now();
	stable_trie<char16_t> t2{ v.begin(), v.end() };
	duration = std::chrono::system_clock::now() - start;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__serialize_6)
{
	using namespace wordring;
	...
	std::cout.imbue(std::locale(""));
	std::cout << "---------- stable_trie_benchmark__serialize_6 ----------" << std::endl;
	std::cout << "stable_trie<char>" << std::endl;
	std::cout << "\tsize():\t" << t1.size() << std::endl;
	std::cout << "\tnodes:\t" << (buf.size() / 2) << std::endl;
	...
	start = std::chrono::system_clock::now();
	stable_trie<char> t2{ v.begin(), v.end() };
	duration = std::chrono::system_clock::now() - start;

	std::cout << "stable_trie<char> t2{ v.begin(), v.end() }: " << std::chrono::duration_cast<std::chrono::milliseconds>(duration).count() << "ms" << std::endl;
	std::cout << "\tsize():\t" << t2.size() << std::endl;

	std::cout << std::endl;
}

BOOST_AUTO_TEST_CASE(stable_trie_benchmark__copy_assignment_1)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__copy_assignment_1 ----------" << std::endl;
	std::cout << "stable_trie<char32_t>" << std::endl;
	std::cout << "\tsize():\t" << t1.size() << std::endl;
	std::cout << "\tnodes:\t" << (buf.size() / 2) << std::endl;

	auto start = std::chrono::system_clock::now();
	stable_trie<char32_t> t2 = t1;
	auto duration = std::chrono::system_clock::now() - start;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__copy_assignment_2)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__copy_assignment_2 ----------" << std::endl;
	std::cout << "stable_trie<char16_t>" << std::endl;
	std::cout << "\tsize():\t" << t1.size() << std::endl;
	std::cout << "\tnodes:\t" << (buf.size() / 2) << std::endl;

	auto start = std::chrono::system_clock::now();
	stable_trie<char16_t> t2 = t1;
	auto duration = std::chrono::system_clock::now() - start;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__copy_assignment_3)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__copy_assignment_3 ----------" << std::endl;
	std::cout << "stable_trie<char>" << std::endl;
	std::cout << "\tsize():\t" << t1.size() << std::endl;
	std::cout << "\tnodes:\t" << (buf.size() / 2) << std::endl;

	auto start = std::chrono::system_clock::now();
	stable_trie<char> t2 = t1;
	auto duration = std::chrono::system_clock::now() - start;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__words_raw_1)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__words_raw_1 ----------" << std::endl;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__words_raw_2)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__words_raw_2 ----------" << std::endl;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__words_raw_3)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__words_raw_3 ----------" << std::endl;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__words_sorted_1)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__words_sorted_1 ----------" << std::endl;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__words_sorted_2)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__words_sorted_2 ----------" << std::endl;
...
BOOST_AUTO_TEST_CASE(stable_trie_benchmark__words_sorted_3)
{
	using namespace wordring;
	...
	std::cout << "---------- stable_trie_benchmark__words_sorted_3 ----------" << std::endl;
