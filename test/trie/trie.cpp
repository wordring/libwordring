...
BOOST_AUTO_TEST_CASE(trie__assign__3)
{
	std::vector<std::string> v1{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> t1;
	t1.assign(v1.begin(), v1.end());
...
BOOST_AUTO_TEST_CASE(trie__assign__4)
{
...
BOOST_AUTO_TEST_CASE(trie__assign__5)
{
...
BOOST_AUTO_TEST_CASE(trie__assign__6)
{
...
BOOST_AUTO_TEST_CASE(trie__assign__7)
{
...
BOOST_AUTO_TEST_CASE(trie__assign__8)
{
...
BOOST_AUTO_TEST_CASE(trie__assign__9)
{
...
BOOST_AUTO_TEST_CASE(trie__at__5)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__at__6)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__at__7)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__at__8)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__at__9)
{
...
BOOST_AUTO_TEST_CASE(trie__at__10)
{
...
BOOST_AUTO_TEST_CASE(trie__at__11)
{
...
BOOST_AUTO_TEST_CASE(trie__begin__1)
{
	test_trie<char32_t> trie{};
	BOOST_CHECK(trie.begin() != trie.end());
}

BOOST_AUTO_TEST_CASE(trie__begin__2)
{
	test_trie<char16_t> trie{};
	BOOST_CHECK(trie.begin() != trie.end());
}

BOOST_AUTO_TEST_CASE(trie__begin__3)
{
	test_trie<char> trie{};
	BOOST_CHECK(trie.begin() != trie.end());
}
...
BOOST_AUTO_TEST_CASE(trie__cbegin__1)
{
	test_trie<char32_t> trie{};
	BOOST_CHECK(trie.cbegin() != trie.cend());
}

BOOST_AUTO_TEST_CASE(trie__cbegin__2)
{
	test_trie<char16_t> trie{};
	BOOST_CHECK(trie.cbegin() != trie.cend());
}

BOOST_AUTO_TEST_CASE(trie__cbegin__3)
{
	test_trie<char> trie{};
	BOOST_CHECK(trie.cbegin() != trie.cend());
}
...
BOOST_AUTO_TEST_CASE(trie__end__1)
{
	test_trie<char32_t> trie{};
	BOOST_CHECK(trie.begin() != trie.end());
}

BOOST_AUTO_TEST_CASE(trie__end__2)
{
	test_trie<char16_t> trie{};
	BOOST_CHECK(trie.begin() != trie.end());
}

BOOST_AUTO_TEST_CASE(trie__end__3)
{
	test_trie<char> trie{};
	BOOST_CHECK(trie.begin() != trie.end());
}
...
BOOST_AUTO_TEST_CASE(trie__cend__1)
{
	test_trie<char32_t> trie{};
	BOOST_CHECK(trie.cbegin() != trie.cend());
}

BOOST_AUTO_TEST_CASE(trie__cend__2)
{
	test_trie<char16_t> trie{};
	BOOST_CHECK(trie.cbegin() != trie.cend());
}

BOOST_AUTO_TEST_CASE(trie__cend__3)
{
	test_trie<char> trie{};
	BOOST_CHECK(trie.cbegin() != trie.cend());
}
...
BOOST_AUTO_TEST_CASE(trie__empty__1)
{
	test_trie<char32_t> trie{};
	BOOST_CHECK(trie.empty());
}

BOOST_AUTO_TEST_CASE(trie__empty__2)
{
	test_trie<char16_t> trie{};
	BOOST_CHECK(trie.empty());
}

BOOST_AUTO_TEST_CASE(trie__empty__3)
{
	test_trie<char> trie{};
	BOOST_CHECK(trie.empty());
}

BOOST_AUTO_TEST_CASE(trie__empty__4)
{
	test_trie<char32_t> trie{};
...
BOOST_AUTO_TEST_CASE(trie__empty__5)
{
	test_trie<char16_t> trie{};
...
BOOST_AUTO_TEST_CASE(trie__empty__6)
{
	test_trie<char> trie{};
...
BOOST_AUTO_TEST_CASE(trie__size__1)
{
	test_trie<char32_t> trie{};
	BOOST_CHECK(trie.size() == 0);
}

BOOST_AUTO_TEST_CASE(trie__size__2)
{
	test_trie<char16_t> trie{};
	BOOST_CHECK(trie.size() == 0);
}

BOOST_AUTO_TEST_CASE(trie__size__3)
{
	test_trie<char> trie{};
	BOOST_CHECK(trie.size() == 0);
}

BOOST_AUTO_TEST_CASE(trie__size__4)
{
	test_trie<char32_t> trie{};
	trie.insert(std::u32string(U"abc"));
...
BOOST_AUTO_TEST_CASE(trie__size__5)
{
	test_trie<char16_t> trie{};
	trie.insert(std::u16string(u"abc"));
	BOOST_CHECK(trie.size() == 1);
...
BOOST_AUTO_TEST_CASE(trie__size__6)
{
	test_trie<char> trie{};
	trie.insert(std::string("abc"));
	BOOST_CHECK(trie.size() == 1);
...
BOOST_AUTO_TEST_CASE(trie__max_size__1)
{
	test_trie<char32_t> trie{};
	BOOST_CHECK(trie.max_size());
}

BOOST_AUTO_TEST_CASE(trie__max_size__2)
{
	test_trie<char16_t> trie{};
	BOOST_CHECK(trie.max_size());
}

BOOST_AUTO_TEST_CASE(trie__max_size__3)
{
	test_trie<char> trie{};
	BOOST_CHECK(trie.max_size());
}
...
BOOST_AUTO_TEST_CASE(trie__insert__3)
{
	test_trie<char32_t> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__4)
{
	test_trie<char32_t> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__5)
{
	test_trie<char32_t> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__6)
{
	test_trie<char16_t> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__7)
{
	test_trie<char16_t> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__8)
{
	test_trie<char16_t> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__9)
{
	test_trie<char16_t> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__10)
{
	test_trie<char16_t> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__11)
{
	test_trie<char> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__12)
{
	test_trie<char> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__13)
{
	test_trie<char> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__14)
{
	test_trie<char> trie;
...
BOOST_AUTO_TEST_CASE(trie__insert__15)
{
	test_trie<char> trie;
...
BOOST_AUTO_TEST_CASE(trie__erase__4)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__erase__5)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__erase__6)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__erase__7)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__erase__8)
{
	std::vector<std::u32string> v{};
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__erase__9)
{
	std::vector<std::u32string> v{};
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__lookup__2)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__lookup__3)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__lookup__4)
{
	std::vector<std::u32string> v{};
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__lookup__5)
{
	std::vector<std::u16string> v{};
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__lookup__6)
{
	std::vector<std::string> v{};
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__lookup__7)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__lookup__8)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__lookup__9)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
*/
BOOST_AUTO_TEST_CASE(trie__lookup__10)
{
	using namespace wordring;
...
BOOST_AUTO_TEST_CASE(trie__lookup__11)
{
	using namespace wordring;
...
BOOST_AUTO_TEST_CASE(trie__lookup__12)
{
	using namespace wordring;
...
BOOST_AUTO_TEST_CASE(trie__search__2)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__find__2)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__find__3)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__find__4)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__find__5)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__find__6)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(trie__contains__3)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
