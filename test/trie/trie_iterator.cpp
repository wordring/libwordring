...
namespace
{
	...
	template <typename Label>
	using test_trie = wordring::trie<Label>;
}

BOOST_AUTO_TEST_SUITE(trie_iterator__test)

// ----------------------------------------------------------------------------
// const_trie_iterator
// ----------------------------------------------------------------------------

BOOST_AUTO_TEST_CASE(const_trie_iterator__constrcut__1)
{
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__constrcut__2)
{
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__constrcut__3)
{
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__reference__1)
{
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__reference__2)
{
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__reference__3)
{
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__at__2)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__at__3)
{
	std::vector<std::string> v{ u8"あ", u8"あう", u8"い", u8"うあい", u8"うえ" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__increment__1)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__increment__2)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__increment__3)
{
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__increment__4)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__increment__5)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__increment__6)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__string__2)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__string__3)
{
	std::vector<std::string> v{ u8"あ", u8"あう", u8"い", u8"うあい", u8"うえ" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__parent__2)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__parent__3)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__begin__1)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__begin__2)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__begin__3)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__end__1)
{
	test_trie<char32_t> trie;
	BOOST_CHECK(trie.begin() != trie.end());
}

BOOST_AUTO_TEST_CASE(const_trie_iterator__end__2)
{
	test_trie<char16_t> trie;
	BOOST_CHECK(trie.begin() != trie.end());
}

BOOST_AUTO_TEST_CASE(const_trie_iterator__end__3)
{
	test_trie<char> trie;
	BOOST_CHECK(trie.begin() != trie.end());
}
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__equal__1)
{
	std::vector<std::u32string> v{ U"あ", U"あう", U"い", U"うあい", U"うえ" };
	test_trie<char32_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__equal__2)
{
	std::vector<std::u16string> v{ u"あ", u"あう", u"い", u"うあい", u"うえ" };
	test_trie<char16_t> trie;
	trie.assign(v.begin(), v.end());
...
BOOST_AUTO_TEST_CASE(const_trie_iterator__equal__3)
{
	std::vector<std::string> v{ "a", "ac", "b", "cab", "cd" };
	test_trie<char> trie;
	trie.assign(v.begin(), v.end());
...
// inline bool operator!=(const_trie_iterator<Label1, Base1> const& lhs, const_trie_iterator<Label1, Base1> const& rhs)
BOOST_AUTO_TEST_CASE(const_trie_iterator__not_equal__1)
{
	test_trie<char32_t> trie;
	BOOST_CHECK(trie.begin() != trie.end());
}

BOOST_AUTO_TEST_CASE(const_trie_iterator__not_equal__2)
{
	test_trie<char16_t> trie;
	BOOST_CHECK(trie.begin() != trie.end());
}

BOOST_AUTO_TEST_CASE(const_trie_iterator__not_equal__3)
{
	test_trie<char> trie;
	BOOST_CHECK(trie.begin() != trie.end());
}
