...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_1)
{
	...
	basic_html_atom<std::string, ns_name> a1, a2("http://www.w3.org/1999/xhtml");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_4)
{
	...
	basic_html_atom<std::string, ns_name> a1(ns_name::HTML), a2("http://www.w3.org/1999/xhtml");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_5)
{
	...
	basic_html_atom<std::string, tag_name> a1(tag_name::Abbr), a2("abbr");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_6)
{
	...
	basic_html_atom<std::string, attribute_name> a1(attribute_name::Accent), a2("accent");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_7)
{
	...
	basic_html_atom<std::string, ns_name> a1("1"), a2("1"), a3("2");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_12)
{
	...
	basic_html_atom<std::string, ns_name> a1(ns_name::HTML), a2(U"http://www.w3.org/1999/xhtml");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_13)
{
	...
	basic_html_atom<std::string, tag_name> a1(tag_name::Abbr), a2(U"abbr");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_14)
{
	...
	basic_html_atom<std::string, attribute_name> a1(attribute_name::Accent), a2(U"accent");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_15)
{
	...
	basic_html_atom<std::string, ns_name> a1(U"1"), a2(U"1"), a3(U"2");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_16)
{
	...
	basic_html_atom<std::string, ns_name> a1(ns_name::HTML), a2(ns_name::HTML), a3(ns_name::MathML);
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_17)
{
	...
	basic_html_atom<std::string, tag_name> a1(tag_name::A), a2(tag_name::A), a3(tag_name::Abbr);
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_18)
{
	...
	basic_html_atom<std::string, attribute_name> a1(attribute_name::Accent), a2(attribute_name::Accent), a3(attribute_name::Accentunder);
...
BOOST_AUTO_TEST_CASE(basic_html_atom_construct_19)
{
	...
	basic_html_atom<std::string, attribute_name> a1(attribute_name::Accent), a2(static_cast<attribute_name>(0));
...
BOOST_AUTO_TEST_CASE(basic_html_atom_operator_atom_type_1)
{
	...
	basic_html_atom<std::string, ns_name> a("http://www.w3.org/1999/xhtml");
...
BOOST_AUTO_TEST_CASE(basic_html_atom_equal_1)
{
	...
	basic_html_atom<std::string, ns_name> a1("http://www.w3.org/1999/xhtml"), a2("http://www.w3.org/1999/xhtml");
